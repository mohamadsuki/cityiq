          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-1">
              ...
              <div className="text-lg font-medium text-red-700">
                {(kpiData.delayedBudget / 1000).toFixed(0)}<span className="text-xs">אלש"ח</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-1">
              ...
              <div className="text-lg font-medium text-blue-700">
                {(kpiData.activeAndPlanningBudget / 1000).toFixed(0)}<span className="text-xs">אלש"ח</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-1">
              ...
              <div className="text-lg font-medium text-purple-700">
                {(kpiData.allActiveBudget / 1000).toFixed(0)}<span className="text-xs">אלש"ח</span>
              </div>
            </div>
          </CardContent>
        </Card>
