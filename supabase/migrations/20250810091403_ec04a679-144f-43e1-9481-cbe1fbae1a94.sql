...
CREATE POLICY IF NOT EXISTS "Users can view their own grants"
ON public.grants FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can insert their own grants"
ON public.grants FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can update their own grants"
ON public.grants FOR UPDATE USING (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can delete their own grants"
...
CREATE POLICY IF NOT EXISTS "Users can view their own institutions"
ON public.institutions FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can insert their own institutions"
ON public.institutions FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can update their own institutions"
ON public.institutions FOR UPDATE USING (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can delete their own institutions"
...
CREATE POLICY IF NOT EXISTS "Users can view their own plans"
ON public.plans FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can insert their own plans"
ON public.plans FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can update their own plans"
ON public.plans FOR UPDATE USING (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can delete their own plans"
...
CREATE POLICY IF NOT EXISTS "Users can view their own welfare services"
ON public.welfare_services FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can insert their own welfare services"
ON public.welfare_services FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can update their own welfare services"
ON public.welfare_services FOR UPDATE USING (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can delete their own welfare services"
...
CREATE POLICY IF NOT EXISTS "Users can view their own ingestion logs"
ON public.ingestion_logs FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY IF NOT EXISTS "Users can insert their own ingestion logs"
