-- Clean up demo system and ensure proper structure for real users

-- 1. Drop demo-related functions
...
-- 2. Drop demo_user_mapping table
DROP TABLE IF EXISTS public.demo_user_mapping;

-- 3. Update all RLS policies to use standard functions
